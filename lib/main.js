    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (ref.startsWith('refs/tags/') && fromProtectedOnly) {
                const { data: heads, } = yield octokit.repos.listBranchesForHeadCommit(Object.assign({}, repo, { commit_sha: sha }));
                if (!heads.length) {
            ...
            yield octokit.git.updateRef(Object.assign({}, repo, { sha: sha, ref: `heads/${branch}`, force }));
        }
        catch (error) {
